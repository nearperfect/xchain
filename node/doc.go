...
/*
Package node sets up multi-protocol MoacNode nodes.
...
endpoint to a subset of RPC modules. Node itself offers the "debug", "admin" and "chain3"
modules.
...
Node also creates the shared store of encrypted MoacNode account keys. Services can access
