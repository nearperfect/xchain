...
// PublicChain3API offers helper utils
type PublicChain3API struct {
	stack *Node
}

// NewPublicChain3API creates a new Chain3Service instance
func NewPublicChain3API(stack *Node) *PublicChain3API {
	return &PublicChain3API{stack}
}

// ClientVersion returns the node name
func (s *PublicChain3API) ClientVersion() string {
	return s.stack.Server().Name
}

// Sha3 applies the moac sha3 implementation on the input.
// It assumes the input is hex encoded.
func (s *PublicChain3API) Sha3(input hexutil.Bytes) hexutil.Bytes {
