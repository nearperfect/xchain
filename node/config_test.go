...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "moac.ipc", false, filepath.Join(os.TempDir(), "moac.ipc")},
		{"data", "moac.ipc", false, "data/moac.ipc"},
		{"data", "./moac.ipc", false, "./moac.ipc"},
		{"data", "/moac.ipc", false, "/moac.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "moac.ipc", true, `\\.\pipe\moac.ipc`},
		{"data", "moac.ipc", true, `\\.\pipe\moac.ipc`},
		{"data", `\\.\pipe\moac.ipc`, true, `\\.\pipe\moac.ipc`},
	}
