...
To compile the moac project under commandline condition:
    ...
    ~$cd go/src/github.com/innowells/MoacCore
    ~/go/src/github.com/innowells/MoacCore$export GOPATH=~/go #
    ~/go/src/github.com/innowells/MoacCore$go run build/ci.go install ./cmd/moac
    ...
    github.com/MOACChain/xchain/cmd/moac
    ~/go/src/github.com/innowells/MoacCore$./build/bin/moac -your-parameters
