...
type txPool interface {
	...
	// SubscribeShardingTxEvent should return an event subscription of
	// ShardingTxEvent and send events to the given channel.
	SubscribeShardingTxEvent(chan<- core.ShardingTxEvent) event.Subscription
}
