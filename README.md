...
[![API Reference]](https://godoc.org/github.com/MOACChain/xchain)
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/MOACChain/xchain?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)
...
[Installation Instructions](https://github.com/MOACChain/xchain/wiki/Building-MoacNode)
on the wiki.
...
[CLI Wiki page](https://github.com/MOACChain/xchain/wiki/Command-Line-Options)), but we've
 ...
 * Start up Moac's built-in interactive [JavaScript console](https://github.com/MOACChain/xchain/wiki/JavaScript-Console),
   (via the trailing `console` subcommand) through which you can invoke all official [`web3` methods](https://github.com/ethereum/wiki/wiki/JavaScript-API)
   as well as Moac's own [management APIs](https://github.com/MOACChain/xchain/wiki/Management-APIs).
...
[MOAC specific APIs](https://github.com/MOACChain/xchain/wiki/Management-APIs)). These can be
...
Please see the [Developers' Guide](https://github.com/MOACChain/xchain/wiki/Developers'-Guide)
